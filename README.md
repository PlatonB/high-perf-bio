...
- Наглядность:
    ...
    - для просмотра баз также существует бесплатный _MongoDB Compass_.
- Автоматизация:
...
- [Проблемы](https://www.mongodb.com/community/forums/t/proposal-boost-the-performance-of-bioinformatic-annotation-queries/170995) с производительностью при запросах по нескольким полям, несмотря на задействование индексов.
