...
#### KDE.
Лично у меня там [не получилось](https://github.com/streamlit/streamlit/issues/4845) запустить _Streamlit_. Так что откладываю написание соответствующей инструкции до лучших времён.
