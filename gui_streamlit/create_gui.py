        ...
        def __init__(self, version, authors):
                with st.form(key='create'):
                        ...
                        with st.expander(label='description'):
                                st.text(body=CreateDescr(version, authors).ru)
...
class AddWidgetsEn():
        ...
        def __init__(self, version, authors):
                with st.form(key='create'):
                        st.header(body='create')
                        with st.expander(label='description'):
                                st.text(body=CreateDescr(version, authors).en)
